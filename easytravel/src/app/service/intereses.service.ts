...
import { UsuarioInteresDTO } from '../model/UsuarioInteresDTO';
...
export class InteresesService {
  ...
  getInteresCountByUser(): Observable<UsuarioInteresDTO[]> {
    return this.http.get<UsuarioInteresDTO[]>(`${this.url}/intereses-count`);
  }
}
